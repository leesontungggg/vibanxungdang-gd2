$(function () {
    ...
    errorMessage = {
        email: 'Vui lòng nhập đúng email', // 'lap.transang@gmail.com',
    ...
    showErrorWithMessage = function (type, message) {
        switch(type) {
            case registrationType.PROFILE:
                ...
                TweenMax.to(profileError, 0.3, {alpha: 1, ease: Sine.easeOut});
                profileError.html(message);
            break;
            case registrationType.LOGIN:
                TweenMax.killTweensOf(loginError)
                TweenMax.to(loginError, 0.3, {alpha: 1, ease: Sine.easeOut});
    ...
    hideError = function (type) {
        switch(type) {
            case registrationType.PROFILE:
                TweenMax.killTweensOf(profileError)
                TweenMax.to(profileError, 0.3, {alpha: 0, ease: Sine.easeOut});
            break;
            case registrationType.LOGIN:
                TweenMax.killTweensOf(loginError)
                TweenMax.to(loginError, 0.3, {alpha: 0, ease: Sine.easeOut});
            break;
        }
    },
    ...
    showCongrate = function () {
        congrateHolder.css({display: 'block'})
    },
    hideCongrate = function () {
        congrateHolder.css({display: 'none'})
    },
    ...
    hideCongrateMessage = function () {
        TweenMax.killTweensOf(congrateMessage)
        TweenMax.to(congrateMessage, 0.3, {autoAlpha: 1, ease: Sine.easeOut, onComplete: () => {
